# Form implementation for the Stopwatch mask dialog.
# Hand-generated by casper_dsp/scripts/gen_block_gui.py to match the layout
# in ui/stopwatch.ui -- if PyQt6/pyuic6 is available, regenerate with:
#   pyuic6 ui/stopwatch.ui -o stopwatch_ui.py
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.count_width, 1, 1, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.title_label.setText(_translate("MainWindow", "Stopwatch"))
        self.desc_label.setText(_translate("MainWindow", "Counts the number of clocks between a start and stop pulse. count_width is added here (not a casper_library mask param) for the Xcos port's explicit output width."))
