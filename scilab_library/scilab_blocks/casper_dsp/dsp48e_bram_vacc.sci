...
function [x, y, typ] = dsp48e_bram_vacc(job, arg1, arg2)
    ...
    case 'define' then
        ...
        x = init_exprs(x);
        x.graphics.style = dsp48e_bram_vacc_build_style(x.graphics.exprs(1));
...
function [x] = dsp48e_bram_vacc_update_ports(obj, bconfigfn)
    ...
    graphics.style = dsp48e_bram_vacc_build_style(p('name'));
    x.graphics = graphics;
    x.model = model;
endfunction
...
function [style] = dsp48e_bram_vacc_build_style(name)
