...
function [x, y, typ] = snap2(job, arg1, arg2)
    ...
    case 'define' then
        ...
        x.graphics.style = 'shape=rectangle;fillColor=yellow;strokeColor=black;fontColor=black;fontSize=12;fontStyle=1;align=center;verticalAlign=middle;noLabel=0;displayedLabel=SNAP2;whiteSpace=wrap;html=1;';
        x = init_exprs(x);
...
function [x] = snap2_refresh(obj, bconfigfn)
    ...
    x = obj;
    graphics = x.graphics;
    graphics.style = 'shape=rectangle;fillColor=yellow;strokeColor=black;fontColor=black;fontSize=12;fontStyle=1;align=center;verticalAlign=middle;noLabel=0;displayedLabel=SNAP2;whiteSpace=wrap;html=1;';
    x.graphics = graphics;
endfunction
