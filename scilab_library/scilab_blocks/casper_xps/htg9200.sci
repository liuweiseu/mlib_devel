// htg9200: Xcos block definition, PyQt6-mask pattern. Hand-written
...
function [x, y, typ] = htg9200(job, arg1, arg2)
    x=[];y=[];typ=[];
    select job
    case 'set' then
        x = arg1;
    ...
    case 'define' then
        ...
        x.graphics.style = 'shape=rectangle;fillColor=yellow;strokeColor=black;fontColor=black;fontSize=12;fontStyle=1;align=center;verticalAlign=middle;noLabel=0;displayedLabel=HTG-9200;whiteSpace=wrap;html=1;';
        x = init_exprs(x);
        debug_info('htg9200 block loaded...')
    end
endfunction

function [x] = htg9200_refresh(obj, bconfigfn)
    ...
    x = obj;
    graphics = x.graphics;
    graphics.style = 'shape=rectangle;fillColor=yellow;strokeColor=black;fontColor=black;fontSize=12;fontStyle=1;align=center;verticalAlign=middle;noLabel=0;displayedLabel=HTG-9200;whiteSpace=wrap;html=1;';
    x.graphics = graphics;
endfunction
