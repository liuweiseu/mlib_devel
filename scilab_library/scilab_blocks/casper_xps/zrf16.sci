// zrf16: Xcos block definition, PyQt6-mask pattern. Hand-written
...
function [x, y, typ] = zrf16(job, arg1, arg2)
    x=[];y=[];typ=[];
    select job
    case 'set' then
        x = arg1;
...
function [x] = zrf16_refresh(obj, bconfigfn)
