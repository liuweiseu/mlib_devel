// casia_k7_21cma: Xcos block definition, PyQt6-mask pattern. Hand-written
...
function [x, y, typ] = casia_k7_21cma(job, arg1, arg2)
    x=[];y=[];typ=[];
    select job
    case 'set' then
        x = arg1;
        ...
        x = casia_k7_21cma_refresh(x, bconfig);
    case 'define' then
        tag = 'casia_k7_21cma';
        model = scicos_model();
        ...
        gr_i = [];
        exprs = [];
        x=standard_define([9.6 4.8],model,exprs,gr_i)
        ...
        x.graphics.style = 'shape=rectangle;fillColor=yellow;strokeColor=black;fontColor=black;fontSize=10;fontStyle=1;align=center;verticalAlign=middle;noLabel=0;displayedLabel=CASIA-K7-21CMA;whiteSpace=wrap;html=1;';
        x = init_exprs(x);
        debug_info('casia_k7_21cma block loaded...')
    end
endfunction

function [x] = casia_k7_21cma_refresh(obj, bconfigfn)
    ...
    x = obj;
    graphics = x.graphics;
    graphics.style = 'shape=rectangle;fillColor=yellow;strokeColor=black;fontColor=black;fontSize=10;fontStyle=1;align=center;verticalAlign=middle;noLabel=0;displayedLabel=CASIA-K7-21CMA;whiteSpace=wrap;html=1;';
    x.graphics = graphics;
endfunction
