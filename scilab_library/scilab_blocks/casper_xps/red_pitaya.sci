// red_pitaya: Xcos block definition, PyQt6-mask pattern. Hand-written
...
function [x, y, typ] = red_pitaya(job, arg1, arg2)
    x=[];y=[];typ=[];
    select job
    case 'set' then
        x = arg1;
        ...
        x = red_pitaya_refresh(x, bconfig);
    case 'define' then
        tag = 'red_pitaya';
        model = scicos_model();
        ...
        x.graphics.style = 'shape=rectangle;fillColor=yellow;strokeColor=black;fontColor=black;fontSize=12;fontStyle=1;align=center;verticalAlign=middle;noLabel=0;displayedLabel=Red Pitaya;whiteSpace=wrap;html=1;';
        x = init_exprs(x);
        debug_info('red_pitaya block loaded...')
    end
endfunction

function [x] = red_pitaya_refresh(obj, bconfigfn)
    ...
    x = obj;
    graphics = x.graphics;
    graphics.style = 'shape=rectangle;fillColor=yellow;strokeColor=black;fontColor=black;fontSize=12;fontStyle=1;align=center;verticalAlign=middle;noLabel=0;displayedLabel=Red Pitaya;whiteSpace=wrap;html=1;';
    x.graphics = graphics;
endfunction
